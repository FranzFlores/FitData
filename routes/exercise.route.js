...
router.put('/update/:id', [auth.ensureAuth, md_upload], exerciseController.updateExercise);
router.put('/updateState/:id', auth.ensureAuth, exerciseController.updateStatusExercise);
